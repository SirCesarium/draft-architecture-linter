...
export async function activate(context: ExtensionContext) {
  ...
  if (platform === 'linux') {
    binaryName = arch === 'arm64' 
      ? 'sweet-analyzer-lsp_aarch64-unknown-linux-gnu' 
      : 'sweet-analyzer-lsp_x86_64-unknown-linux-gnu';
  } else if (platform === 'win32') {
    binaryName = 'sweet-analyzer-lsp_x86_64-pc-windows-msvc.exe';
  } else if (platform === 'darwin') {
    binaryName = arch === 'arm64'
      ? 'sweet-analyzer-lsp_aarch64-apple-darwin'
      : 'sweet-analyzer-lsp_x86_64-apple-darwin';
  }
